      ...
      return knex('entries').insert([
        {
            id: 1,
            user_id: 1,
            timestamp: knex.select(knex.raw('date_add(?, INTERVAL ? day)', [knex.fn.now(), -2])),
        ...
        },
        {
            id: 2,
            user_id: 1,
            timestamp: knex.select(knex.raw('date_add(?, INTERVAL ? day)', [knex.fn.now(), -30])),
        ...
        },
        {
            id: 3,
            user_id: 1,
            timestamp: knex.select(knex.raw('date_add(?, INTERVAL ? day)', [knex.fn.now(), -16])),
        ...
        },
        {
            id: 4,
            user_id: 1,
            timestamp: knex.select(knex.raw('date_add(?, INTERVAL ? day)', [knex.fn.now(), -90])),
            title: 'Justice',
        ...
        },
        {
            id: 5,
            user_id: 1,
            timestamp: knex.select(knex.raw('date_add(?, INTERVAL ? day)', [knex.fn.now(), -35])),
        ...
        },
        {
            id: 6,
            user_id: 1,
            timestamp: knex.select(knex.raw('date_add(?, INTERVAL ? day)', [knex.fn.now(), -70])),
        ...
        },
        {
            id: 7,
            user_id: 1,
            timestamp: knex.select(knex.raw('date_add(?, INTERVAL ? day)', [knex.fn.now(), -45])),
            title: 'Pathways',
        ...
        },
        {
            id: 8,
            user_id: 1,
            timestamp: knex.select(knex.raw('date_add(?, INTERVAL ? day)', [knex.fn.now(), -32])),
            title: 'Fortune',
